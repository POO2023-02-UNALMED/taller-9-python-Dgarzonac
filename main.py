...
boton_punto = Button(root, text=".", command = clickBoton_punto, width=9, height=3, bg="spring green", fg="black", cursor="hand2", borderwidth=0).grid(row=4, column=1, padx=1, pady=1)
